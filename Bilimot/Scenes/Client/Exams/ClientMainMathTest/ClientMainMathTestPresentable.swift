//
//  ClientMainMathTestPresentable.swift
//  Bilimot
//
...
final class ClientMainMathTestPresentable: BaseView {

    var pushToLesson = CurrentValueSubject<String, Never>("")
    private var lessons: [String] = ["Сынамык 001 (Негизги тест - математика)"]
...
extension ClientMainMathTestPresentable: UITableViewDelegate, UITableViewDataSource {
